...
export class UIntAdjWasmMesher extends UIntMesher {
    ...
    static async createMesher() {
        ...
        const uIntWasmMesherResult = await WebAssembly.instantiateStreaming(
            await fetch(Resources.relativeToRoot("./mesh/uIntAdjWasmMesher.wasm")),
            {
                env: {
                    memory: mem
                }
    ...
    static async createFastMesher() {
        ...
        const uIntWasmMesherResult = await WebAssembly.instantiateStreaming(
            await fetch(Resources.relativeToRoot("./mesh/uIntAdjWasmMesherQ.wasm")),
            {
                env: {
                    memory: mem
                }
